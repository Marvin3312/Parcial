...
<html lang="es">
  <head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?php echo $path; ?>/Parcial/web/views/assets/favicon.png" />
    <!-- Google fonts-->
    ...
    <!-- Custom CSS -->
    <link rel="icon" type="image/png" href="<?php echo $path; ?>/Parcial/web/views/assets/img/favicon.png" />
    <link rel="stylesheet" href="<?php echo $path; ?>/Parcial/web/views/assets/css/styles.css">
